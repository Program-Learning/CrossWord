...
!function (l) {
    ...
    Array.prototype.indexOf = Array.prototype.indexOf || function (n, i) {
        ...
        c && d.touchEventsSupported() && (n = {
            ...
            1 === t.touches.length && (c.addEventListener("touchmove", i, !!d.passiveSupported && {passive: !1}), c.addEventListener("touchend", o), c.addEventListener("touchcancel", o), n.timeStart = Date.now(), n.pointerStart.x = n.pointerEnd.x = t.touches[0].clientX, n.pointerStart.y = n.pointerEnd.y = t.touches[0].clientY, n.distanceX = n.distanceY = 0, n.direction = "none", r.onTouchStart) && r.onTouchStart(t, n)
        }, i = function (t) {
...
!function (i, D) {
    ...
    var n = i.layui && layui.define, l = {
        ...
        }, C = "layui-this", M = "laydate-disabled", h = [100, 2e5], v = "layui-laydate-static", b = "layui-laydate-list",
        o = "laydate-selected", r = "layui-laydate-hint", y = "laydate-day-prev", m = "laydate-day-next",
        L = ".laydate-btns-confirm", E = "laydate-time-text", I = "laydate-btns-time", x = "layui-laydate-preview",
    ...
    s.formatArr = function (e) {
        ...
        }), a = l.now < l.min || l.max < l.now || i.isDisabledDateTime(l.now, t), t.elem && t.elem[a ? "addClass" : "removeClass"](M), a
        ...
        return s.year < h[0] && (s.year = h[0], d.hint(y.invalidDate)), s.year > h[1] && (s.year = h[1], d.hint(y.invalidDate)), d.firstDate || (d.firstDate = lay.extend({}, s)), n.setFullYear(s.year, s.month, 1), l = (n.getDay() + (7 - a.weekStart)) % 7, r = T.getEndDate(s.month || 12, s.year), o = T.getEndDate(s.month + 1, s.year), lay.each(u, function (e, t) {
            ...
            (t = lay(t)).removeAttr("class"), e < l ? (a = r - l + e, t.addClass("laydate-day-prev"), n = d.getAsYM(s.year, s.month, "sub")) : l <= e && e < o + l ? (a = e - l, d.rangeLinked || a + 1 === s.date && t.addClass(C)) : (a = e - o - l, t.addClass("laydate-day-next"), n = d.getAsYM(s.year, s.month)), n[1]++, n[2] = a + 1, t.attr("lay-ymd", n.join("-")).html("<div>" + n[2] + "</div>"), d.mark(t, n).holidays(t, n).limit({
                elem: t,
            ...
            elem: lay(d.footer).find(L),
            index: 0,
            time: u,
            disabledType: "datetime"
        })), d.setBtnStatus(), lay(d.shortcut).find("li." + C).removeClass(C), a.range && !m && "init" !== t && d.stampRange(), d
        ...
        return x[0] < 1 && (x[0] = 1), "year" === n ? (e = l = x[0] - 7, l < 1 && (e = l = 1), lay.each(new Array(15), function (e) {
            ...
            l == x[0] && lay(t).addClass(C), t.innerHTML = l + v, h.appendChild(t), s.limit({
                elem: lay(t),
                date: a,
                index: i,
                type: n,
            ...
            e + 1 == x[1] && lay(t).addClass(C), t.innerHTML = u.month[e] + (T ? "\u6708" : ""), h.appendChild(t), s.limit({
                elem: lay(t),
                date: a,
                index: i,
                type: n,
            ...
            lay.each(new Array(e), function (e) {
                n.push("<li" + (s[k][w[t]] === e ? ' class="' + C + '"' : "") + ">" + lay.digit(e, 2) + "</li>")
        ...
        })) : (f = lay.elem("span", {"class": E}), d = function () {
        ...
        }, t = lay(p[2]).find("." + E), d(), f.innerHTML = y.range ? [u.startTime, u.endTime][i] : u.timeTips, lay(s.elemMain[i]).addClass("laydate-time-show"), t[0] && t.remove(), p[2].appendChild(f), (D = lay(h).find("ol")).each(function (t) {
            var a = this;
            lay(a).find("li").on("click", function () {
                var e = 0 | this.innerHTML;
                lay(this).hasClass(M) || (y.range ? s[k][w[t]] = e : m[w[t]] = e, lay(a).find("." + C).removeClass(C), lay(this).addClass(C), r(), d(), !s.endDate && "time" !== y.type && "datetime" !== y.type || s.done(null, "change"), s.setBtnStatus())
            })
        ...
        }), lay(a.elem).find("." + E).remove()
    }, k.prototype.setBtnStatus = function (e, t, a) {
        var n = this, i = n.config, l = n.lang(), r = lay(n.footer).find(L),
        ...
        l.range && !i.endState && lay(i.footer).find(L).addClass(M), r = r && i.newDate({
            year: r.year,
            month: r.month,
            date: r.date
        ...
        var a = this, n = a.config, i = a.lang(), l = n.dateTime, r = "static" === n.position, o = {
            datetime: function () {
                ...
                if (n.range) {
                    if (lay(t).hasClass(M)) return ("time" === n.type ? a.startTime && a.endTime && a.newDate(a.startTime) > a.newDate(a.endTime) : a.startDate && a.endDate && a.newDate(lay.extend({}, a.startDate, a.startTime || {})) > a.newDate(lay.extend({}, a.endDate, a.endTime || {}))) ? a.hint("time" === n.type ? i.timeout.replace(/\u65e5\u671f/g, "\u65f6\u95f4") : i.timeout) : a.hint(i.invalidDate)
        ...
        n(D).on("mousedown", function (e) {
            ...
            var t;
            T.thisId && (t = s.getThis(T.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === k.thisElemDate && (e.preventDefault(), n(t.footer).find(L)[0].click())
...
!function (p, h) {
    "use strict";
    var m, g, e, n = p.layui && layui.define, d = {
            ...
            confirm: function (e, t, i, n) {
                ...
                return a && (n = i, i = t), v.open(m.extend({content: e, btn: d.btn, yes: i, btn2: n}, a ? {} : t))
            },
            msg: function (e, t, i) {
            ...
            load: function (e, t) {
                return v.open(m.extend({type: 3, icon: e || 0, resize: !1, shade: .01, removeFocus: !1}, t))
            },
            tips: function (e, t, i) {
        ...
        l = "LAYUI_LAYER_CONTENT_RECORD_HEIGHT", i = (t.pt.config = {
            ...
            var e, t, i, n, a = this, o = a.config, s = a.index, r = "object" == typeof (f = o.content), l = m("body"),
                c = function (e) {
                    var t;
            ...
            var n = this, a = n.config, e = m(document), o = n.layero, l = ["LAY_MOVE_DICT", "LAY_RESIZE_DICT"],
            ...
            var t = e.attr("type"), i = e.find(".layui-layer-content"), t = t === d.type[2] ? i.children("iframe") : i,
            ...
            e.find(".layui-layer-max").addClass("layui-layer-maxmin"), e.attr({area: n}), i.data(l, d.getStyle(t[0], "height"))
            ...
            var t, i, n;
            e && (t = v.getChildFrame("html", e).outerHeight(), i = (e = m("#" + u[0] + e)).find(u[1]).outerHeight() || 0, n = e.find("." + u[6]).outerHeight() || 0, e.css({height: t + i + n}), e.find("iframe").css({height: t}))
            ...
            var i, n, a, o, s, r, l = m("#" + u[0] + e), c = l.data("maxminStatus");
            ...
            var t = m("#" + u[0] + e), i = m("#" + u.SHADE + e), n = t.find(".layui-layer-content"),
            ...
            t.removeData("maxminStatus"), v.style(e, {
                ...
                overflow: "visible"
            }, !0), t.find(".layui-layer-max").removeClass("layui-layer-maxmin"), t.find(".layui-layer-min").show(), "page" === o && t.find(u[4]).show(), s.scrollbar ? d.restScrollbar(e) : d.setScrollbar(e), r !== h && (n.removeData(l), (o === d.type[2] ? n.children("iframe") : n).css({height: r})), i.show()
        }, v.full = function (t) {
            ...
            var r, e, t,
                l = (i = m("." + u[0]).children("#" + o).closest("." + u[0]))[0] ? (o = i.attr("times"), i) : m("#" + u[0] + o),
                c = l.attr("type"), i = l.data("config") || {}, f = i.id && i.hideOnClose;
            l[0] && (r = {
            ...
            }, t = m("#" + u.SHADE + o), v.ie && v.ie < 10 || !i.isOutAnim ? t[f ? "hide" : "remove"]() : (t.css({opacity: 0}), setTimeout(function () {
                t[f ? "hide" : "remove"]()
        ...
        if ((n = m.extend(!0, {toolbar: !0, footer: !0}, n)).photos) {
            ...
            if (s.imgIndex = 1 + (0 | r), n.img = n.img || "img", delete n.success, t) {
                ...
                if (e || c.on("click", n.img, function () {
                    ...
                    v.photos(m.extend(n, {photos: {start: e, data: o, tab: n.tab}, full: n.full}), !0)
                }), !e) return
            }
            ...
            }, s.loadi = v.load(1, {shade: !("shade" in n) && [.9, h, "unset"], scrollbar: !1});
            var t = o[r].src, d = function (e) {
                v.close(s.loadi);
                var t, i = o[r].alt || "";
...
layui.define(["jquery", "laytpl", "lay", "util"], function (e) {
    ...
    var n, i, t, c = layui.$, m = layui.laytpl, p = layui.util, l = layui.hint(),
        ...
        T = "layui-dropdown-shade", k = "." + s + ">." + w, E = function (e) {
            var i = this;
    ...
    E.prototype.config = {
        ...
        }), n) : (c.extend(l, lay.options(a[0])), !e && a[0] && a.data(y) ? (t = g.getThis(a.data(y))) ? t.reload(l, i) : void 0 : (l.elem = c(l.elem), l.id = "id" in l ? l.id : a.attr("id") || n.index, lay.isTopElem(a[0]) || a.attr(f, l.id), l.customName = c.extend({}, h.config.customName, l.customName), (l.show || "reloadData" === i && n.elemView && c("body").find(n.elemView.get(0)).length) && n.render(e, i), void n.events()))
        ...
        n && (i = n.attr(f), e = n.data("prevElem"), t = (i = g.getThis(i)).config.close, e && e.data(y + "_opened", !1), n.remove(), delete g.prevElem, "function" == typeof t) && t.call(i.config, e), lay("." + T).remove()
    ...
    d.prototype.config = {
        ...
        e.on("mousedown", function (e) {
            ...
            layui.stope(e), b(function (e) {
                var i = n + (e.clientY - c), o = l + (e.clientX - a), t = d[0].offsetHeight, r = d[0].offsetWidth,
        ...
        this.config;
        var r = j({h: e, s: 100, b: 100}), e = (j({h: e, s: i, b: o}), e / 360 * 180), o = 180 - o / 100 * 180,
            i = i / 100 * 260, n = this.elemPicker.find("." + I)[0];
        this.elemPicker.find("." + B).css("top", e), n.style.background = "#" + r, this.elemPicker.find("." + E).css({
            top: o / n.offsetHeight * 100 + "%",
            left: i / n.offsetWidth * 100 + "%"
        })
...
layui.define(["lay", "layer"], function (e) {
    "use strict";
    var x = layui.$, a = layui.lay, i = layui.layer, b = layui.device(), t = "upload", c = "layui_" + t + "_index",
        s = {
        ...
        }, l = "layui-upload-file", r = "layui-upload-form", F = "layui-upload-iframe", w = "layui-upload-choose",
        L = "UPLOADING", z = function (e) {
            var i = this;
    ...
    z.prototype.config = {
        ...
        }), i) : (x.extend(t, a.options(n[0], {attr: n.attr("lay-data") ? "lay-data" : null})), !e && n[0] && n.data(c) ? (e = o.getThis(n.data(c))) ? e.reload(t) : void 0 : (t.elem = x(t.elem), t.bindAction = x(t.bindAction), t.id = "id" in t ? t.id : n.attr("id") || i.index, i.file(), void i.events()))
    }, z.prototype.file = function () {
        var e = this, i = e.config,
            t = e.elemFile = x(['<input class="' + l + '" type="file" accept="' + i.acceptMime + '" name="' + i.field + '"', i.multiple ? " multiple" : "", ">"].join("")),
            n = i.elem.next();
        (n.hasClass(l) || n.hasClass(r)) && n.remove(), b.ie && b.ie < 10 && i.elem.wrap('<div class="layui-upload-wrap"></div>'), e.isFile() ? (e.elemFile = i.elem, i.field = i.elem[0].name) : i.elem.after(t), b.ie && b.ie < 10 && e.initIE()
    }, z.prototype.initIE = function () {
        var t, e = this.config,
            i = x('<iframe id="' + F + '" class="' + F + '" name="' + F + '" frameborder="0"></iframe>'),
            n = x(['<form target="' + F + '" class="' + r + '" method="post" key="set-mine" enctype="multipart/form-data" action="' + e.url + '">', "</form>"].join(""));
        x("#" + F)[0] || x("body").append(i), e.elem.next().hasClass(r) || (this.elemFile.wrap(n), e.elem.next("." + r).append((t = [], layui.each(e.data, function (e, i) {
        ...
        var t, n, a, o, u = this, f = u.config, c = f.text || {}, l = u.elemFile[0], s = function () {
            ...
            var n = x("#" + F);
            u.elemFile.parent().submit(), clearInterval(z.timer), z.timer = setInterval(function () {
        ...
        if (0 !== g.length) {
            switch (f.accept) {
                ...
                default:
                    layui.each(g, function (e, i) {
                        if (!RegExp(".\\.(" + (h || "jpg|png|gif|bmp|jpeg|svg|webp") + ")$", "i").test(escape(i))) return t = !0
                    })
            }
        ...
        var a = this, n = a.config, o = function (e) {
            a.chooseFiles = {}, layui.each(e, function (e, i) {
                var t = (new Date).getTime();
                a.chooseFiles[t + "-" + e] = i
            })
        }, l = function (e, i) {
            var t = a.elemFile,
                e = (n.item || n.elem, 1 < e.length ? e.length + "\u4e2a\u6587\u4ef6" : (e[0] || {}).name || t[0].value.match(/[^\/\\]+\..+/g) || []);
            t.next().hasClass(w) && t.next().remove(), a.upload(null, "choose"), a.isFile() || n.choose || t.after('<span class="layui-inline ' + w + '">' + e + "</span>")
        }, r = function (t) {
            var n = !0;
            return layui.each(a.files, function (e, i) {
                if (!(n = !(i.name === t.name))) return !0
            }), n
        }, u = function (e) {
            var t = function (e) {
                e.ext = e.name.substr(e.name.lastIndexOf(".") + 1).toLowerCase(), e.sizes = s.util.parseSize(e.size)
            };
            return e instanceof FileList ? layui.each(e, function (e, i) {
                t(i)
            }) : t(e), e
        }, f = function (e) {
            var t;
            return (e = e || []).length ? a.files ? (t = [], layui.each(e, function (e, i) {
                r(i) && t.push(u(i))
            }), t) : u(e) : []
        };
        n.elem.off("upload.start").on("upload.start", function () {
        ...
        }), b.ie && b.ie < 10 || n.elem.off("upload.over").on("upload.over", function () {
            x(this).attr("lay-over", "")
        }).off("upload.leave").on("upload.leave", function () {
            x(this).removeAttr("lay-over")
        }).off("upload.drop").on("upload.drop", function (e, i) {
            var t = x(this), i = f(i.originalEvent.dataTransfer.files);
            ...
            a.upload()
        }), n.elem.data(c) || (n.elem.on("click", function () {
        ...
        parseSize: function (e, i) {
            var t, n;
            return i = i || 2, null != e && e ? (t = "string" == typeof e ? parseFloat(e) : e, n = Math.floor(Math.log(t) / Math.log(1024)), (e = (e = t / Math.pow(1024, n)) % 1 == 0 ? e : parseFloat(e.toFixed(i))) + ["Bytes", "Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Zb", "Yb"][n]) : "0"
        }
...
layui.define(["lay", "layer", "util"], function (e) {
    "use strict";
    var T = layui.$, h = layui.layer, N = layui.util, l = layui.hint(), $ = (layui.device(), "form"), u = ".layui-form",
        _ = "layui-this", F = "layui-hide", A = "layui-disabled", t = function () {
            this.config = {
                verify: {
                    required: function (e) {
            ...
            var i = this.config, a = T(u + (t ? '[lay-filter="' + t + '"]' : "")), n = {
                input: function (e) {
                    var e = e || a.find("input,textarea"),
                        t = (i.autocomplete && e.attr("autocomplete", i.autocomplete), function (e, t) {
                            ...
                            }).increment[r <= a && !o ? "addClass" : "removeClass"](A), n.decrement[a <= l && !o ? "addClass" : "removeClass"](A))
                        });
                            ...
                            u = "layui-input-affix", e = r.is("[disabled]") || r.is("[readonly]"), d = function (e, t) {
                                ...
                                var a, t = T('<div class="' + u + '">'), e = layui.isArray(i.value) ? i.value : [i.value],
                                    e = T((a = [], layui.each(e, function (e, t) {
                                        a.push('<i class="layui-icon layui-icon-' + t + (i.disabled ? " " + A : "") + '"></i>')
                                    }), a.join(""))),
                                ...
                                l[0] ? ((n = l.find("." + u))[0] && n.remove(), l.prepend(t), r.css("padding-right", function () {
                                    ...
                                    T(this).hasClass(A) || ("function" == typeof i.click && i.click.call(this, r, i), layui.event.call(this, $, "input-affix(" + e + ")", {
                                        elem: r[0],
                                        affix: s,
                                        options: i
                                    }))
                    ...
                    var m, u = "\u8bf7\u9009\u62e9", g = "layui-form-select", b = "layui-select-title",
                        x = "layui-select-none", k = "layui-select-create-option", C = "", e = e || a.find("select"),
                        w = function (e, t) {
                            T(e.target).parent().hasClass(b) && !t || ((e = T("." + g)).removeClass(g + "ed " + g + "up"), e.hasClass("layui-select-creatable") && e.children("dl").children("." + k).remove(), m && C && m.val(C)), m = null
                        }, d = function (n, e, t, c) {
                            var s, u, a, i, o, d, l, r = T(this), f = n.find("." + b), h = f.find("input"), y = n.find("dl"),
                                p = (y.children("dd"), y.children("dt")), v = this.selectedIndex;
                            e || (u = r.attr("lay-search"), a = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !h.attr("placeholder")), i = function () {
                                var e = n.offset().top + n.outerHeight() + 5 - j.scrollTop(), t = y.outerHeight(),
                                    i = y.children("dd");
                                v = r[0].selectedIndex, n.addClass(g + "ed"), i.removeClass(F), p.removeClass(F), s = null, i.removeClass(_), 0 <= v && i.eq(v).addClass(_), e + t > j.height() && t <= e && n.addClass(g + "up"), d(), a && y.off("mousedown.select.ieph").on("mousedown.select.ieph", function () {
                                    h[0].__ieph = !0, setTimeout(function () {
                                        h[0].__ieph = !1
                                    }, 60)
                                })
                            }, o = function (e) {
                                n.removeClass(g + "ed " + g + "up"), h.blur(), s = null, c && y.children("." + k).remove(), e || l(h.val(), function (e) {
                                    var t = r[0].selectedIndex;
                                    e && (C = T(r[0].options[t]).html(), 0 === t && C === h.attr("placeholder") && (C = ""), h.val(C || ""))
                                })
                            }, d = function () {
                                var e, t, i = y.children("dd." + _);
                                i[0] && (e = i.position().top, t = y.height(), i = i.height(), t < e && y.scrollTop(e + y.scrollTop() - t + i - 5), e < 0) && y.scrollTop(e + y.scrollTop() - 5)
                                ...
                                var e = l.keyCode, r = (9 === e && o(), function (a, n) {
                                    l.preventDefault();
                                    var e = function () {
                                        var e = y.children("dd." + _);
                                        if (y.children("dd." + F)[0] && "next" === a) {
                                            var t = y.children("dd:not(." + F + ",." + A + ")"), i = t.eq(0).index();
                                            if (0 <= i && i < e.index() && !t.hasClass(_)) return t.eq(0).prev()[0] ? t.eq(0).prev() : y.children(":last")
                                        }
                                        return n && n[0] ? n : s && s[0] ? s : e
                                    }(), t = e[a](), i = e[a]("dd:not(." + F + ")");
                                    return t[0] ? (s = e[a](), i[0] && !i.hasClass(A) || !s[0] ? (i.addClass(_).siblings().removeClass(_), void d()) : r(a, s)) : s = null
                                });
                                38 === e && r("prev"), 40 === e && r("next"), 13 === e && (l.preventDefault(), y.children("dd." + _).trigger("click"))
                            }).on("paste", function () {
                                i()
                            }), l = function (n, e, l) {
                                var r = 0, t = y.children("dd"), s = !1, o = n, t = (layui.each(t, function () {
                                    var e = T(this), t = e.text(), i = c && e.hasClass(k),
                                        a = (c && !i && t === o && (s = !0), "cs" !== u && (t = t.toLowerCase(), n = n.toLowerCase()), -1 === t.indexOf(n));
                                    ("" === n || "blur" === l ? n !== t : a) && r++, "keyup" === l && e[(c ? a && !i : a) ? "addClass" : "removeClass"](F)
                                }), "keyup" === l && layui.each(p, function () {
                                    var e = T(this), t = e.nextUntil("dt").filter("dd");
                                    e[(t = c ? t.not("." + k) : t).length == t.filter("." + F).length ? "addClass" : "removeClass"](F)
                                }), r === t.length);
                                return e(t, s), t
                            }, t && h.on("input propertychange", layui.debounce(function (e) {
                                var i = this.value, t = e.keyCode;
                                return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (a && e.target.__ieph ? e.target.__ieph = !1 : (l(i, function (e, t) {
                                    c ? t ? y.children("." + k).remove() : (t = y.children("." + k))[0] ? t.attr("lay-value", i).html(N.escape(i)) : ((t = T("<dd>")).addClass(k).attr("lay-value", i).html(N.escape(i)), y.append(t)) : e ? y.find("." + x)[0] || y.append('<p class="' + x + '">\u65e0\u5339\u914d\u9879</p>') : y.find("." + x).remove()
                                }, "keyup"), "" === i && (r.val(""), y.find("." + _).removeClass(_), (r[0].options[0] || {}).value || y.children("dd:eq(0)").addClass(_), y.find("." + x).remove(), c) && y.children("." + k).remove(), void d()))
                            }, 50)).on("blur", function (e) {
                                var t = r[0].selectedIndex;
                                m = h, C = T(r[0].options[t]).text(), 0 === t && C === h.attr("placeholder") && (C = ""), setTimeout(function () {
                                    l(h.val(), function (e) {
                                        C || h.val("")
                                    }, "blur")
                                }, 200)
                            }), y.on("click", "dd", function () {
                                var e, t = T(this), i = t.attr("lay-value"), a = r.attr("lay-filter");
                                return t.hasClass(A) || (t.hasClass("layui-select-tips") ? h.val("") : (h.val(t.text()), t.addClass(_)), c && t.hasClass(k) && (t.removeClass(k), (e = T("<option>")).attr("value", i).text(t.text()), r.append(e)), t.siblings().removeClass(_), r.val(i).removeClass("layui-form-danger"), layui.event.call(this, $, "select(" + a + ")", {
                                    elem: r[0],
                                    value: i,
                                    othis: n
                                }), o(!0)), !1
                    ...
                    e.each(function (e, t) {
                        var i = T(this), a = i.next("." + g), n = this.disabled, l = t.value,
                        ...
                        var s, o = "string" == typeof i.attr("lay-search"),
                            c = "string" == typeof i.attr("lay-creatable") && o, t = t && !t.value && t.innerHTML || u,
                            r = T(['<div class="' + (o ? "" : "layui-unselect ") + g, n ? " layui-select-disabled" : "", (c ? " layui-select-creatable" : "") + '">', '<div class="' + b + '">', '<input type="text" placeholder="' + N.escape(T.trim(t)) + '" value="' + N.escape(T.trim(l ? r.html() : "")) + '"' + (!n && o ? "" : " readonly") + ' class="layui-input' + (o ? "" : " layui-unselect") + (n ? " " + A : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (t = i.find("*"), s = [], layui.each(t, function (e, t) {
                                var i = t.tagName.toLowerCase();
                                0 !== e || t.value || "optgroup" === i ? s.push("optgroup" === i ? "<dt>" + t.label + "</dt>" : '<dd lay-value="' + N.escape(t.value) + '" class="' + (l === t.value ? _ : "") + (t.disabled ? " " + A : "") + '">' + T.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + T.trim(t.innerHTML || u) + "</dd>")
                            }), 0 === s.length && s.push('<dd lay-value="" class="' + A + '">\u6ca1\u6709\u9009\u9879</dd>'), s.join("") + "</dl>"), "</div>"].join(""));
                    ...
                    e.each(function (e, t) {
                        ...
                        l = T(['<div class="layui-unselect ' + r[0], t.checked ? " " + r[1] : "", l ? " layui-checkbox-disabled " + A : "", '"', a ? ' lay-skin="' + a + '"' : "", ">", (s = {
                        ...
                        i.after(l), function (a, n) {
                            var l = T(this);
                            a.on("click", function () {
                                var e = T(this), t = l.attr("lay-filter"),
                                    e = e.next("*[lay-checkbox]")[0] ? e.next().html() : l.attr("title") || "",
                                    i = l.attr("lay-skin") || "primary", e = "switch" === i ? e.split("|") : [e];
                                l[0].disabled || (l[0].indeterminate && (l[0].indeterminate = !1, a.find("." + c.SUBTRA).removeClass(c.SUBTRA).addClass("layui-icon-ok")), l[0].checked ? (l[0].checked = !1, a.removeClass(n[1]), "switch" === i && a.children("div").html(e[1])) : (l[0].checked = !0, a.addClass(n[1]), "switch" === i && a.children("div").html(e[0])), layui.event.call(l[0], $, n[2] + "(" + t + ")", {
                                    elem: l[0],
                                    value: l[0].value,
                                    othis: a
                                }))
                    ...
                    e.each(function (e, t) {
                        ...
                        var a = N.escape(t.title || ""), r = [],
                            ...
                            }), r = r.join(" "), T(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + A : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
                        i.after(s), function (a) {
                            var n = T(this), l = "layui-anim-scaleSpring";
                            a.on("click", function () {
                                var e = n[0].name, t = n.parents(u), i = n.attr("lay-filter"),
                                    e = t.find("input[name=" + e.replace(/(\.|#|\[|\])/g, "\\$1") + "]");
                                n[0].disabled || (layui.each(e, function () {
                                    var e = T(this).next("." + o);
                                    this.checked = !1, e.removeClass(o + "ed"), e.children(".layui-icon").removeClass(l + " " + c[0]).addClass(c[1])
                                }), n[0].checked = !0, a.addClass(o + "ed"), a.children(".layui-icon").addClass(l + " " + c[0]), layui.event.call(n[0], $, "radio(" + i + ")", {
                                    elem: n[0],
                                    value: n[0].value,
                                    othis: a
                                }))
            ...
            return "object" === layui.type(e) ? T(e).is(u) ? (a = T(e), t()) : e.each(function (e, t) {
                var i = T(t);
                i.closest(u).length && ("SELECT" === t.tagName ? n.select(i) : "INPUT" === t.tagName && ("checkbox" === (t = t.type) || "radio" === t ? n[t](i) : n.input(i)))
            ...
            var i = {}, a = T(this), e = "string" == typeof e ? e : a.attr("lay-filter"),
                n = this.getFormElem ? this.getFormElem(e) : a.parents(u).eq(0), l = n.find("*[lay-verify]");
        ...
        }), r = new t, t = T(document), j = T(window);
    T(function () {
        r.render()
    ...
    }), t.on("submit", u, i).on("click", "*[lay-submit]", i), e($, r)
});
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (n) {
    "use strict";
    var f = layui.$, d = layui.lay, m = layui.laytpl, O = layui.laypage, p = layui.layer, v = layui.form,
        ...
        }, N = "table", R = "lay-" + N + "-id", t = ".layui-table", D = "layui-hide", y = "layui-hide-v", h = "layui-none",
        L = "layui-table-view", o = ".layui-table-header", E = ".layui-table-body", u = ".layui-table-fixed-r",
        P = ".layui-table-pageview", A = ".layui-table-sort", _ = "layui-table-checked", M = "layui-table-edit",
        W = "layui-table-hover", I = "laytable-cell-group", H = "layui-table-col-special", j = "layui-table-tool-panel",
        S = "layui-table-expanded", F = "LAY_TABLE_MOVE_DICT", e = function (e) {
        ...
        r = f(window), z = f(document), i = function (e) {
            ...
            a.index = t.index, t.key = a.id || a.index, t.setInit(), a.height && /^full-.+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1], a.height = r.height() - (parseFloat(t.fullHeightGap) || 0)) : a.height && /^#\w+\S*-.+$/.test(a.height) ? (i = a.height.split("-"), t.parentHeightGap = i.pop(), t.parentDiv = i.join("-"), a.height = f(t.parentDiv).height() - (parseFloat(t.parentHeightGap) || 0)) : "function" == typeof a.height && (t.customHeightFunc = a.height, a.height = t.customHeightFunc());
            var l, e = a.elem, i = e.next("." + L), n = t.elem = f("<div></div>");
            n.addClass((l = [L, L + "-" + t.index, "layui-form", "layui-border-box"], a.className && l.push(a.className), l.join(" "))).attr(((l = {
                "lay-filter": "LAY-TABLE-FORM-DF-" + t.index,
                style: (l = [], a.width && l.push("width:" + a.width + "px;"), l.join(""))
            })[R] = a.id, l)).html(m(s, {open: "{{", close: "}}"}).render({
                data: a,
                index: t.index
            })), t.renderStyle(), i[0] && (t.resizeObserver && t.resizeObserver.unobserve(t.elem[0]), i.remove()), e.after(n), t.layTool = n.find(".layui-table-tool"), t.layBox = n.find(".layui-table-box"), t.layHeader = n.find(o), t.layMain = n.find(".layui-table-main"), t.layBody = n.find(E), t.layFixed = n.find(".layui-table-fixed"), t.layFixLeft = n.find(".layui-table-fixed-l"), t.layFixRight = n.find(u), t.layTotal = n.find(".layui-table-total"), t.layPage = n.find(".layui-table-page"), t.renderToolbar(), t.renderPagebar(), t.fullSize(), t.pullData(t.page), t.events()
            ...
            var l, a, r = this, d = r.config;
            if (d.clientWidth = d.width || (l = function (e) {
                var t, a = (e = e || d.elem.parent()).width();
                try {
                    t = "none" === e.css("display")
                } catch (i) {
                }
                return !e[0] || a && !t ? a : l(e.parent())
            })(), "width" === e) return d.clientWidth;
            d.height = d.maxHeight || d.height, d.css && -1 === d.css.indexOf(L) && (a = d.css.split("}"), layui.each(a, function (e, t) {
                t && (a[e] = "." + L + "-" + r.index + " " + t)
            }), d.css = a.join("}"));
            var c = function (a, e, i, l) {
                var n, o;
                l ? (l.key = [d.index, a, i].join("-"), l.colspan = l.colspan || 0, l.rowspan = l.rowspan || 0, r.initOpts(l), (n = a + (parseInt(l.rowspan) || 1)) < d.cols.length ? (l.colGroup = !0, o = 0, layui.each(d.cols[n], function (e, t) {
                    t.HAS_PARENT || 1 <= o && o == (l.colspan || 1) || (t.HAS_PARENT = !0, t.parentKey = [d.index, a, i].join("-"), o += parseInt(1 < t.colspan ? t.colspan : 1), c(n, d.cols[n], e, t))
            ...
            layui.each(l.cols, function (a, e) {
                ...
                t && o.push(a + " " + t)
            })), l.css && o.push(l.css), d.style({target: this.elem[0], text: o.join(""), id: "DF-table-" + n})
            ...
            i[0] && (t = t.split("-"), t = a.cols[t[1]][t[2]], e ? l-- : l++, i.attr("colspan", l), i[l ? "removeClass" : "addClass"](D), t.colspan2 = l, t.hide = l < 1, a = i.data("parentkey")) && this.setParentCol(e, a)
            ...
            var t, a, n = this, r = n.config, i = 0, d = 0, c = 0, s = 0, u = n.setInit("width"),
                e = (n.eachCols(function (e, t) {
                    t.hide || i++
                }), u = u - ("line" === r.skin || "nob" === r.skin ? 2 : i + 1) - n.getScrollWidth(n.layMain[0]) - 1, function (o) {
                    layui.each(r.cols, function (e, n) {
                        layui.each(n, function (e, t) {
                            var a = 0, i = t.minWidth || r.cellMinWidth, l = t.maxWidth || r.cellMaxWidth;
                            t ? t.colGroup || t.hide || (o ? c && c < i ? (d--, a = i) : c && l < c && (d--, a = l) : (a = t.width || 0, /\d+%$/.test(a) ? l < (a = (a = Math.floor(parseFloat(a) / 100 * u)) < i ? i : a) && (a = l) : a ? "normal" === t.type && (a < i && (t.width = a = i), l < a) && (t.width = a = l) : (t.width = a = 0, d++)), t.hide && (a = 0), s += a) : n.splice(e, 1)
                        })
                    }), s < u && 0 < d && (c = (u - s) / d)
                }), l = (e(), e(!0), n.autoColNums = d = 0 < d ? d : 0, n.eachCols(function (e, a) {
                    var i = a.minWidth || r.cellMinWidth, l = a.maxWidth || r.cellMaxWidth;
            ...
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(D), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(y), t.layPage.find(P).addClass(y), k.cache[t.key] = [], t.syncCheckAll(), t.renderForm(), t.setColsWidth(), t.loading(!1)
        }, i.prototype.page = 1, i.prototype.pullData = function (a, t) {
            var e, i, l = this, n = l.config,
                o = (n.HAS_SET_COLS_PATCH || l.setColsPatch(), n.HAS_SET_COLS_PATCH = !0, n.request), r = n.response,
                d = function () {
                    ...
                    l.setColsWidth(), l.loading(!1), "function" == typeof n.done && n.done(e, a, e[r.countName], t)
                };
            t = t || {}, "function" == typeof n.before && n.before(n), l.startTime = (new Date).getTime(), t.renderData ? ((e = {})[r.dataName] = k.cache[l.key], e[r.countName] = n.url ? "object" === layui.type(n.page) ? n.page.count : e[r.dataName].length : n.data.length, "object" == typeof n.totalRow && (e[r.totalRowName] = f.extend({}, l.totalRow)), l.renderData({
                res: e,
                curr: a,
                count: e[r.countName],
                type: t.type,
                sort: !0
            }), c(e, "renderData")) : n.url ? (i = {}, n.page && (i[o.pageName] = a, i[o.limitName] = n.limit), o = f.extend(i, n.where), n.contentType && 0 == n.contentType.indexOf("application/json") && (o = JSON.stringify(o)), l.loading(!0), f.ajax({
                type: n.method || "get",
                url: n.url,
                ...
                success: function (e) {
                    (e = "function" == typeof n.parseData ? n.parseData(e) || e : e)[r.statusName] != r.statusCode ? l.errorView(e[r.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + r.statusName + '": ' + r.statusCode) : (l.totalRow = e[r.totalRowName], l.renderData({
                        res: e,
                        curr: a,
                        count: e[r.countName],
                        type: t.type
                    }), d(), n.time = (new Date).getTime() - l.startTime + " ms"), c(e, t.type)
                },
                error: function (e, t) {
                    l.errorView("\u8bf7\u6c42\u5f02\u5e38\uff0c\u9519\u8bef\u63d0\u793a\uff1a" + t), "function" == typeof n.error && n.error(e, t)
                }
            })) : "array" === layui.type(n.data) && (e = {}, i = a * n.limit - n.limit, o = n.data.concat(), e[r.dataName] = n.page ? o.splice(i, n.limit) : o, e[r.countName] = n.data.length, "object" == typeof n.totalRow && (e[r.totalRowName] = f.extend({}, n.totalRow)), l.totalRow = e[r.totalRowName], l.renderData({
                res: e,
                curr: a,
                count: e[r.countName],
                type: t.type
            ...
            return n = n || 1, layui.each(a, function (e, o) {
                ...
                "array" === layui.type(o) && 0 === o.length || (o[k.config.numbersName] = c, l || (o[k.config.indexName] = e), s.eachCols(function (e, l) {
                    ...
                    n !== undefined && null !== n || (n = ""), l.colGroup || (e = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(o) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + g.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(D), l.field || t.push(H), t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + ">" + function () {
                    ...
                    }(), "</div></td>"].join(""), i.push(e), l.fixed && "right" !== l.fixed && r.push(e), "right" === l.fixed && d.push(e))
                }), e = ['data-index="' + e + '"'], o[k.config.checkName] && e.push('class="' + _ + '"'), e = e.join(" "), y.push("<tr " + e + ">" + i.join("") + "</tr>"), h.push("<tr " + e + ">" + r.join("") + "</tr>"), p.push("<tr " + e + ">" + d.join("") + "</tr>"))
            ...
            var a = this, i = a.config, t = e.res, l = e.curr, n = a.count = e.count, o = e.sort,
                r = t[i.response.dataName] || [], t = t[i.response.totalRowName], d = [], c = [], s = [], u = function () {
            ...
            return k.cache[a.key] = r, a.layTotal[0 == r.length ? "addClass" : "removeClass"](y), a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](D), a.layPage.find(P)[!i.page || 0 == n || 0 === r.length && 1 == l ? "addClass" : "removeClass"](y), 0 === r.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(D), o ? u() : (u(), a.renderTotal(r, t), a.layTotal && a.layTotal.removeClass(D), void (i.page && (i.page = f.extend({
            ...
            }), d.dataTotal = [], r = [], d.eachCols(function (e, t) {
                var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2,
                    l = s[e] ? parseFloat(s[e] || 0).toFixed(l) : "",
                    l = (a = t.totalRowText || "", (n = {LAY_COL: t})[e] = l, n = t.totalRow && T.call(d, {
                        item3: t,
                        content: l,
                        tplData: n
                    }) || a, i || n), n = (t.field && d.dataTotal.push({
                        field: t.field,
                        total: f("<div>" + l + "</div>").text()
                    }), ['<td data-field="' + e + '" data-key="' + t.key + '" ' + (a = [], t.minWidth && a.push('data-minwidth="' + t.minWidth + '"'), t.maxWidth && a.push('data-maxwidth="' + t.maxWidth + '"'), t.style && a.push('style="' + t.style + '"'), a.join(" ")) + ' class="' + (n = [], t.hide && n.push(D), t.field || n.push(H), n.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + (a = t.key, "normal" === t.type ? a : a + " laytable-cell-" + t.type) + '"' + (n = [], t.align && n.push('align="' + t.align + '"'), n.join(" ")) + ">" + ("string" == typeof (a = t.totalRow || c.totalRow) ? m(a).render(f.extend({
                        TOTAL_NUMS: i || s[e],
                        TOTAL_ROW: o || {},
                        LAY_COL: t
                    }, t)) : l), "</div></td>"].join(""));
                r.push(n)
            }), e = d.layTotal.find(".layui-table-patch"), d.layTotal.find("tbody").html("<tr>" + r.join("") + (e.length ? e.get(0).outerHTML : "") + "</tr>"))
            ...
            var e = this, l = e.config, n = "all" === i.index, o = "array" === layui.type(i.index),
                r = (t = e.layBody.find("tr"), n ? t : t.filter(o ? function () {
                    var e = f(this).data("index");
                    return -1 !== i.index.indexOf(e)
                } : '[data-index="' + i.index + '"]')), t = (i = f.extend({type: "checkbox"}, i), k.cache[e.key]),
                a = "checked" in i, d = function (e) {
                    return "radio" === i.type || (a ? i.checked : !e)
                }, t = (layui.each(t, function (e, t) {
                    var a;
                    "array" === layui.type(t) || t[l.disabledName] || (n || (o ? -1 !== i.index.indexOf(e) : Number(i.index) === e) ? (a = t[l.checkName] = d(t[l.checkName]), (e = r.filter('[data-index="' + e + '"]'))[a ? "addClass" : "removeClass"](_), "radio" === i.type && e.siblings().removeClass(_)) : "radio" === i.type && delete t[l.checkName])
                }), r.find('input[lay-type="' + ({
                    radio: "layTableRadio",
                    checkbox: "layTableCheckbox"
                }[i.type] || "checkbox") + '"]:not(:disabled)')), c = t.last(), s = c.closest(u);
            ("radio" === i.type && s.hasClass(D) ? t.first() : t).prop("checked", d(c.prop("checked"))), e.syncCheckAll(), e.renderForm(i.type)
        }, i.prototype.sort = function (l) {
            var e, t = this, a = {}, i = t.config, n = i.elem.attr("lay-filter"), o = k.cache[t.key];
            "string" == typeof (l = l || {}).field && (r = l.field, t.layHeader.find("th").each(function (e, t) {
                var a = f(this), i = a.data("field");
                if (i === l.field) return l.field = a, r = i, !1
            }));
            try {
                var r = r || l.field.data("field"), d = l.field.data("key");
            ...
            t.sortKey = {
                field: r,
                sort: l.type
            }, i.autoSort && ("asc" === l.type ? e = layui.sort(o, r, null, !0) : "desc" === l.type ? e = layui.sort(o, r, !0, !0) : (e = layui.sort(o, k.config.indexName, null, !0), delete t.sortKey, delete i.initSort)), a[i.response.dataName] = e || o, t.renderData({
                res: a,
                curr: t.page,
                count: t.count,
                sort: !0,
            ...
            i.fullHeightGap ? (l = r.height() - i.fullHeightGap) < 135 && (l = 135) : i.parentDiv && i.parentHeightGap ? (l = f(i.parentDiv).height() - i.parentHeightGap) < 135 && (l = 135) : i.customHeightFunc && (l = i.customHeightFunc()) < 135 && (l = 135), 1 < t.cols.length && (e = i.layFixed.find(o).find("th"), a = i.layHeader.first(), layui.each(e, function (e, t) {
            ...
            e.layFixed.find(E).css("height", t.height() >= n ? n : "auto").scrollTop(e.layMain.scrollTop()), e.layFixRight[k.cache[e.key] && k.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](D), e.layFixRight.css("right", a - 1)
        }, i.prototype.updateRow = function (e, i) {
            var d = this, c = ".layui-table-cell", e = "array" === layui.type(e) ? e : [e], s = k.cache[d.key] || [];
            layui.each(e, function (e, t) {
                var a, l, n, o, r;
                a = t.index, l = t.data, n = t.related, o = s[a] || {}, r = d.layBody.find('tr[data-index="' + a + '"]'), layui.each(l, function (e, t) {
                    o[e] = t, i && i(e, t)
                }), d.eachCols(function (e, t) {
                    var a, i = String(t.field || e);
                    (i in l || ("function" == typeof n ? n(i, e) : n) && (t.templet || t.toolbar)) && (i = (e = r.children('td[data-field="' + i + '"]')).children(c), a = o[t.field], i.html(T.call(d, {
                        item3: t,
                        content: a,
                        tplData: f.extend({LAY_COL: t}, o)
                    })), e.data("content", a), d.renderFormByElem(i))
                })
            })
        }, k.updateRow = function (e, t) {
            return C(e).updateRow(t)
        }, i.prototype.events = function () {
            var c = this, s = c.config, u = s.elem.attr("lay-filter"), e = c.layHeader.find("th"), y = ".layui-table-cell",
                o = f("body"), r = {}, d = (c.layTool.on("click", "*[lay-event]", function (e) {
                    ...
                    switch (layui.stope(e), z.trigger("table.tool.panel.remove"), p.close(c.tipsIndex), t) {
                        case"LAYTABLE_COLS":
                            n({
                                list: (a = [], c.eachCols(function (e, t) {
                                    ...
                                    v.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                        var e = f(e.elem), t = this.checked, a = e.data("key"), i = c.col(a), l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, c.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](D), l != i.hide && c.setParentCol(!t, e), c.resize(), layui.event.call(this, N, "colToggled(" + u + ")", {
                                            col: i,
                                            config: s
                                        }))
                                    })
                        ...
                        case"LAYTABLE_PRINT":
                            ...
                            var o = window.open("about:blank", "_blank"),
                                r = ["<style>", "body{font-size: 12px; color: #5F5F5F;}", "table{width: 100%; border-collapse: collapse; border-spacing: 0;}", "th,td{line-height: 20px; padding: 9px 15px; border: 1px solid #ccc; text-align: left; font-size: 12px; color: #5F5F5F;}", "a{color: #5F5F5F; text-decoration:none;}", "img{max-height: 100%;}", "*.layui-hide{display: none}", "</style>"].join(""),
                                d = f(c.layHeader.html());
                            d.append(c.layMain.find("table").html()), d.append(c.layTotal.find("table").html()), d.find("th.layui-table-patch").remove(), d.find("thead>tr>th." + H).filter(function (e, t) {
                                return !f(t).children("." + I).length
                            }).remove(), d.find("tbody>tr>td." + H).remove(), o.document.write(r + d.prop("outerHTML")), o.document.close(), layui.device("edg").edg ? (o.onafterprint = o.close, o.print()) : (o.print(), o.close())
                    }
                    layui.event.call(this, N, "toolbar(" + u + ")", f.extend({event: t, config: s}, {}))
                }), c.layHeader.on("click", "*[lay-event]", function (e) {
                    var t = f(this), a = t.attr("lay-event"), t = t.closest("th").data("key"), t = c.col(t);
                    layui.event.call(this, N, "colTool(" + u + ")", f.extend({event: a, config: s, col: t}, {}))
                }), c.layPagebar.on("click", "*[lay-event]", function (e) {
                    var t = f(this).attr("lay-event");
                    layui.event.call(this, N, "pagebar(" + u + ")", f.extend({event: t, config: s}, {}))
                }), e.on("mousemove", function (e) {
                    var t = f(this), a = t.offset().left, e = e.clientX - a;
                    t.data("unresize") || w.eventMoveElem || (r.allowResize = t.width() - e <= 10, o.css("cursor", r.allowResize ? "col-resize" : ""))
                }).on("mouseleave", function () {
                    f(this);
                    ...
                    }), a.data(F, r), w.eventMoveElem = a)
                }), w.docEvent || z.on("mousemove", function (e) {
                    var t, a;
                    w.eventMoveElem && (t = w.eventMoveElem.data(F) || {}, w.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule) && (e = t.ruleWidth + e.clientX - t.offset[0], a = w.eventMoveElem.closest("." + L).attr(R), a = C(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(w.eventMoveElem), p.close(c.tipsIndex))
                }).on("mouseup", function (e) {
                    var t, a, i, l, n;
                    w.eventMoveElem && (i = (t = w.eventMoveElem).closest("." + L).attr(R), a = C(i)) && (i = t.data("key"), l = a.col(i), n = a.config.elem.attr("lay-filter"), r = {}, o.css("cursor", ""), a.scrollPatch(), t.removeData(F), delete w.eventMoveElem, a.cssRules(i, function (e) {
                    ...
                    var t = f(this), a = t.find(A), i = a.attr("lay-sort");
                    ...
                    var a = f(this).parents("tr").eq(0).data("index"), t = c.layBody.find('tr[data-index="' + a + '"]'),
                        i = (k.cache[c.key] || [])[a] || {}, l = {
                            tr: t, config: s, data: k.clearCacheKey(i), dataCache: i, index: a, del: function () {
                    ...
                    t[0].disabled || (n ? c.setRowChecked({index: "all", checked: l}) : (c.setRowChecked({
                        index: i,
                        checked: l
                    }), layui.stope(e)), layui.event.call(t[0], N, "checkbox(" + u + ")", d.call(t[0], {
                        checked: l,
                        type: n ? "all" : "one",
                        getCol: function () {
                    ...
                    c.setRowChecked({
                        type: "radio",
                        index: l
                    }), layui.event.call(t[0], N, "radio(" + u + ")", d.call(t[0], {
                    ...
                    var t = f(this);
                    t.data("off") || layui.event.call(this, N, e + "(" + u + ")", d.call(t.children("td")[0]))
                }), n = function (e, t) {
                    var a, i, l;
                    ...
                    var e = f(this), t = e.parent(), a = this.value, i = e.parent().data("field"),
                        e = e.closest("tr").data("index"), e = k.cache[c.key][e], l = d.call(t[0], {
                    ...
                    var a = f(this), i = a.parent(), l = i.data("key"), n = c.col(l), o = i.parent().data("index"),
                        r = i.children(y), i = "layui-table-cell-c", d = f('<i class="layui-icon layui-icon-up ' + i + '">');
                    "tips" === (t = t || n.expandedMode || s.cellExpandedMode) ? c.tipsIndex = p.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (r.height() + 23) + "px;" + ("sm" === s.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === s.size ? "padding: 14px 15px;" : "") + '">', r.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), r[0], {
                        tips: [3, ""],
                        time: -1,
                        anim: -1,
                    ...
                    }), c.setRowActive(o, S), r.next("." + i)[0] || r.after(d), d.on("click", function () {
                        var t = f(this);
                        c.setRowActive(o, [S, W].join(" "), !0), c.cssRules(l, function (e) {
                            e.style.width = t.data("cell-width"), setTimeout(function () {
                                c.resize()
                            })
                        }), t.remove(), r.scrollTop(0), r.scrollLeft(0)
                    ...
                    c.setRowActive(i), layui.event.call(this, N, (e || "tool") + "(" + u + ")", d.call(this, {
            ...
            c.layBody.on("click", "*[lay-event]", function (e) {
                ...
                c.layHeader.scrollLeft(t), c.layTotal.scrollLeft(t), c.layFixed.find(E).scrollTop(e), p.close(c.tipsIndex)
            ...
            }), window.ResizeObserver && (c.resizeObserver || (c.resizeObserver = new ResizeObserver(function () {
                k.resize(c.key)
            ...
            return e.each(function () {
                var l, e = f(this), t = e.attr("lay-data"),
                    t = d.options(this, {attr: t ? "lay-data" : null, errorText: r + (t || e.attr("lay-options"))}),
                    n = f.extend({
                        elem: this,
                        cols: [],
                        data: [],
                        ...
                        n.cols[i] = [], f(this).children().each(function (e) {
                            var t = f(this), a = t.attr("lay-data"),
                                a = d.options(this, {attr: a ? "lay-data" : null, errorText: r + (a || t.attr("lay-options"))}),
                                t = f.extend({
                                    title: t.text(),
    ...
    k.eachCols = function (e, a, i) {
        ...
        var o, r, i, d, l = (a = "object" == typeof a ? a : (l = {}, a && (l.type = a), l)).type || "csv",
        ...
        u.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [], r = [], i = [], d = {}, layui.each(t, function (i, l) {
            var n = [];
            "object" == typeof e ? (layui.each(e, function (e, t) {
                ...
                var a;
                !1 === t.ignoreExport || t.field && "normal" == t.type ? t.hide && !1 !== t.ignoreExport || !0 === t.ignoreExport ? 0 == i && (d[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""), 0 == i && o.push(t.fieldTitle || t.title || t.field || ""), a = (a = T.call(c, {
                    item3: t,
                    content: a,
                    tplData: l,
                    text: "text",
                ...
                })).replace(/"/g, '""'), n.push(a = '"' + a + '"')) : t.field && "normal" !== t.type && 0 == i && (d[t.field] = !0)
            }), r.push(n.join(","))
        ...
        n && ("boolean" === layui.type(l) ? n.eachCols(function (e, t) {
            ...
            i.hide != l && (i = i.hide = l, n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](D), n.setParentCol(i, t))
        }) : (l = layui.isArray(l) ? l : [l], layui.each(l, function (e, l) {
            n.eachCols(function (e, t) {
                var a, i;
                l.field === t.field && (a = t.key, i = n.col(a), t = t.parentKey, "hide" in l) && i.hide != l.hide && (i = i.hide = !!l.hide, n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](D), n.setParentCol(i, t))
            })
        })), f("." + j).remove(), n.resize())
...
layui.define(["table"], function (e) {
    ...
    var A = layui.$, x = layui.form, P = layui.table, y = layui.hint(), B = {
        ...
        z = "LAY_DATA_INDEX", m = "LAY_DATA_INDEX_HISTORY", f = "LAY_PARENT_INDEX", b = "LAY_CHECKBOX_HALF",
        H = "LAY_EXPAND", X = "LAY_HAS_EXPANDED", V = "LAY_ASYNC_STATUS", n = ["all", "parent", "children", "none"],
        t = /<[^>]+?>/, p = ["flexIconClose", "flexIconOpen", "iconClose", "iconOpen", "iconLeaf", "icon"],
        a = function (e) {
            var t = this;
    ...
    var r, U = function (e, t, a) {
        ...
        var a = j(e);
        if (a) {
            var n, i = a.getOptions(), l = i.tree, d = l.customName.isParent, r = l.customName.children,
                o = i.elem.next(), c = [], u = P.cache[e],
                ...
                t = (layui.each(l, function (e, t) {
                    t = t[z];
                    c.push('tr[lay-data-index="' + t + '"]'), -1 !== t.indexOf("-") && delete u[t]
                }), o.find(c.join(",")).remove(), a.initData());
            for (n in u) -1 !== n.indexOf("-") && n !== u[n][z] && delete u[n];
            layui.each(a.treeToFlat(t), function (e, t) {
                t[m] && t[m] !== t[z] && o.find('tr[lay-data-index="' + t[m] + '"]').attr({
                    "data-index": t[z],
                    "lay-data-index": t[z]
                }).data("index", t[z])
            }), layui.each(u, function (e, t) {
                o.find('tr[data-level="0"][lay-data-index="' + t[z] + '"]').attr("data-index", e).data("index", e)
            }), i.hasNumberCol && v(a), s && (l = o.find('tr[lay-data-index="' + s[z] + '"]'), s[d] = !(!s[r] || !s[r].length), a.updateNodeIcon({
                scopeEl: l,
                isExpand: s[H],
                isParent: s[d]
            })), B.resize(e)
        ...
        return !(a[b] = !1) === n ? a[t].length ? layui.each(a[t], function (e, t) {
            ...
            t[l] && i++
        }), n = a[t].length ? a[t].length === i : a[l], a[b] = !n && 0 < i), a[l] = n, d.push(A.extend({}, a)), d = a[f] ? d.concat(this.updateParentCheckStatus(P.cache[e][a[f]], n)) : d
    }, function (e, t, a) {
    ...
    B.on("checkbox", function (e) {
        ...
        c && (t = c.getOptions().elem.next(), i = (e = e || {}).index, n = e.checked, e = e.callbackFlag, i = "string" === layui.type(i) ? i : i[z], r = c.getNodeDataByIndex(i)) && (l = function (e) {
            o.push(e), t.find('tr[lay-data-index="' + e + '"]').length || (e = c.getNodeDataByIndex(e)[f]) && l(e)
        }, (d = t.find('tr[lay-data-index="' + i + '"]')).length || (r = r[f], o = [], l(r), layui.each(o.reverse(), function (e, t) {
...
layui.define("jquery", function (o) {
    "use strict";
    var v = layui.$, l = function (o) {
    };
    l.prototype.load = function (o) {
        var i, n, r, l, c, m, e, a, f, s, u, p, t, d, y = this, h = 0, g = v((o = o || {}).elem);
        if (g[0]) return c = v(o.scrollElem || document), m = "mb" in o ? o.mb : 50, e = !("isAuto" in o) || o.isAuto, a = o.end || "\u6ca1\u6709\u66f4\u591a\u4e86", f = "top" === (o.direction || "bottom"), y._cleanup(g, c), s = o.scrollElem && o.scrollElem !== document, p = v('<div class="layui-flow-more"><a href="javascript:;">' + (u = "<cite>\u52a0\u8f7d\u66f4\u591a</cite>") + "</a></div>"), g.find(".layui-flow-more")[0] || g[f ? "prepend" : "append"](p), t = function (o, l) {
            var e = s ? c.prop("scrollHeight") : document.documentElement.scrollHeight, t = c.scrollTop();
            o = v(o), p[f ? "after" : "before"](o), (l = 0 == l || null) ? p.html(a) : p.find("a").html(u), n = l, i = null, r && r(), f && (o = s ? c.prop("scrollHeight") : document.documentElement.scrollHeight, 1 === h ? c.scrollTop(o) : 1 < h && c.scrollTop(t + (o - e)))
        }, (d = function () {
            ...
            var e = v(this), t = e.scrollTop();
            l && clearTimeout(l), !n && g.width() && (l = setTimeout(function () {
        ...
        var l, m = this, a = 0, f = v((o = o || {}).scrollElem || document), s = o.elem || "img",
            ...
            p = function (l, o) {
                ...
                var e = (u ? l || f : v(window)).height(), t = f.scrollTop(), i = t + e;
                if (m.lazyimg.elem = v(s), o) p(o, e); else for (var n = 0; n < m.lazyimg.elem.length; n++) {
